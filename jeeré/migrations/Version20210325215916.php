 ...
 */
final class Version20210325215916 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commandes (id INT AUTO_INCREMENT NOT NULL, livreurs_id INT NOT NULL, panier_id INT NOT NULL, facture_id INT NOT NULL, client_id INT NOT NULL, date_commande DATE NOT NULL, etat TINYINT(1) NOT NULL, nom_client VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, INDEX IDX_35D4282C908EE9D4 (livreurs_id), UNIQUE INDEX UNIQ_35D4282CF77D927C (panier_id), UNIQUE INDEX UNIQ_35D4282C7F2DEE08 (facture_id), INDEX IDX_35D4282C19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livreurs (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, ville_id INT NOT NULL, image INT NOT NULL, adresse_livreur VARCHAR(255) NOT NULL, tel_livreur VARCHAR(255) NOT NULL, INDEX IDX_28E6A8A067B3B43D (users_id), INDEX IDX_28E6A8A0A73F0036 (ville_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produits (id INT AUTO_INCREMENT NOT NULL, vendeur_id INT NOT NULL, categorie_id INT NOT NULL, nom_produit VARCHAR(255) NOT NULL, prix_unitaire VARCHAR(255) NOT NULL, quantite_stock VARCHAR(255) NOT NULL, caracteristique VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_ajout DATE NOT NULL, image INT NOT NULL, INDEX IDX_BE2DDF8C858C065E (vendeur_id), INDEX IDX_BE2DDF8CBCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE vendeurs (id INT AUTO_INCREMENT NOT NULL, users_id INT NOT NULL, adresse_vendeur VARCHAR(255) NOT NULL, tel_vendeur VARCHAR(255) NOT NULL, image INT NOT NULL, INDEX IDX_2180DE367B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE commandes ADD CONSTRAINT FK_35D4282CF77D927C FOREIGN KEY (panier_id) REFERENCES paniers (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE paniers_produits DROP FOREIGN KEY FK_7B1D2CABCD11A2CF');
