 ...
 */
final class Version20210318095056 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE commandes (id INT AUTO_INCREMENT NOT NULL, livreurs_id INT NOT NULL, panier_id INT NOT NULL, facture_id INT NOT NULL, client_id INT NOT NULL, date_commande DATE NOT NULL, etat TINYINT(1) NOT NULL, INDEX IDX_35D4282C908EE9D4 (livreurs_id), UNIQUE INDEX UNIQ_35D4282CF77D927C (panier_id), UNIQUE INDEX UNIQ_35D4282C7F2DEE08 (facture_id), INDEX IDX_35D4282C19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livreurs (id INT AUTO_INCREMENT NOT NULL, ville_id INT NOT NULL, users_id INT NOT NULL, photo_cni_l LONGBLOB NOT NULL, adresse_livreur VARCHAR(255) NOT NULL, tel_livreur VARCHAR(255) NOT NULL, INDEX IDX_28E6A8A0A73F0036 (ville_id), INDEX IDX_28E6A8A067B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
